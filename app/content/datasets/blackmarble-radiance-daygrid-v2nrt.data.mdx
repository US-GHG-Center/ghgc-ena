...
name: Black Marble Nighttime at Sensor Radiance
description: Nighttime at sensor radiance observed by Suomi NPP VIIRS Day/Night Band in a linear latitude-longitude projection and gridded at 500m
...
infoDescription: |
  ::markdown 
    ...
    - Data Units: Watts per square centimeter per steradian (nW/cm²/sr)       
...
layers:
  - id: VIIRS_SNPP_DayNightBand_At_Sensor_Radiance
    ...
    name: Nighttime at Sensor Radiance
    type: wmts 
    ...
    info:
      ...
      unit: nW/cm²/sr  
    media:
      src: /images/dataset/black-marble-night-time.png    
