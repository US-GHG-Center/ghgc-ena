...
name: Goddard Earth Observing System (GEOS) Assimilated CO2, CH4, and CO Column Concentrations
...
infoDescription: |
  ::markdown
    ...
    - Data Units: Parts per million (ppm) and Parts per billion (ppb)       
    - Data Type: Research
...
layers:
  - id: geos-ghg-daygrid-vPRE-xco2
    ...
    compare:
      ...
      layerId: geos-ghg-daygrid-vPRE-xco2
      mapLabel: |
  ...
  - id: geos-ghg-daygrid-vPRE-xch4
    ...
    compare:
      datasetId: geos-ghg-daygrid-vPRE
      layerId: geos-ghg-daygrid-vPRE-xch4
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          if (dateFns && datetime && compareDatetime) return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
  ...
  - id: geos-ghg-daygrid-vPRE-xco
    ...
    compare:
      datasetId: geos-ghg-daygrid-vPRE
      layerId: geos-ghg-daygrid-vPRE-xco
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          if (dateFns && datetime && compareDatetime) return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
