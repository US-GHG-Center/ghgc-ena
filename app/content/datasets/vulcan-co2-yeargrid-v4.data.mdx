...
usage:
  ...
  - url: https://data.ghg.center/browseui/index.html#vulcan-ffco2-yeargrid-v4/
    ...
    title: Data Browser
media:
  src: /images/dataset/vulcan--dataset-cover.jpg
...
layers:
  - id: vulcan-total-co2
    ...
    media:
      src: /images/dataset/vulcan-fossil-total-fossil-fuel.png
  ...
  - id: vulcan-air-co2
    ...
    media:
      src: /images/dataset/vulcan-fossil-airport-fossil-fuel.png
      alt: Rendered Fossil Fuel CO₂ Emissions
  - id: vulcan-cmt-co2
    stacCol: vulcan-ffco2-yeargrid-v4
    ...
    media:
      src: /images/dataset/vulcan-fossil-cement-fossil-fuel.png
      alt: Rendered Fossil Fuel CO₂ Emissions
  - id: vulcan-cmv-co2
    stacCol: vulcan-ffco2-yeargrid-v4
    ...
    media:
      src: /images/dataset/vulcan-fossil-commercial-marine.png
      alt: Rendered Fossil Fuel CO₂ Emissions
  - id: vulcan-com-co2
    stacCol: vulcan-ffco2-yeargrid-v4
    ...
    media:
      src: /images/dataset/vulcan-fossil-industrial-fossil.png
      alt: Rendered Fossil Fuel CO₂ Emissions    
  - id: vulcan-elc-co2
    stacCol: vulcan-ffco2-yeargrid-v4
    ...
    media:
      src: /images/dataset/vulcan-fossil-powerplant.png
      alt: Rendered Fossil Fuel CO₂ Emissions                       
  - id: vulcan-ind-co2
    stacCol: vulcan-ffco2-yeargrid-v4
  ...
  - id: vulcan-nrd-co2
    ...
    media:
      src: /images/dataset/vulcan-fossil-nonroad.png
      alt: Rendered Fossil Fuel CO₂ Emissions  
  - id: vulcan-onr-co2
    stacCol: vulcan-ffco2-yeargrid-v4
    ...
    media:
      src: /images/dataset/vulcan-fossil-onroad.png
      alt: Rendered Fossil Fuel CO₂ Emissions  
  - id: vulcan-res-co2
    stacCol: vulcan-ffco2-yeargrid-v4
    ...
    media:
      src: /images/dataset/vulcan-fossil-residential-fossil.png
      alt: Rendered Fossil Fuel CO₂ Emissions
  - id: vulcan-rrd-co2
    stacCol: vulcan-ffco2-yeargrid-v4
    ...
    media:
      src: /images/dataset/vulcan-fossil-railroad-fossil.png
      alt: Rendered Fossil Fuel CO₂ Emissions                                                    
---
<Block>
  <Prose>
